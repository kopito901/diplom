      ...
      <div className="container-fluid personal-page__container">
        <div className="row">
          ...
          <div className="col">
            ...
            <p className="personal-page__manager">Заведующий: { props.studentData.boss.name } { props.studentData.boss.surname } { props.studentData.boss.patronymic }</p>
            ...
            <p className="personal-page__course">Группа: { props.currentUser.Group.number }</p>
            <p className="personal-page__group">Курс: { props.currentUser.CourseId }</p>
          </div>
        </div>
        <div className="row">
          <MainControls />
